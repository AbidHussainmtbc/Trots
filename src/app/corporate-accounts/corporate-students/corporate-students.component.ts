...
import { Bookings, CorpStudent, corpSubject } from 'src/app/Classes/corporate';
import { ApiServiceService } from 'src/app/services/api-service.service';
import { ToastService } from 'src/app/services/toast.service';
import { SubjectModelComponent } from '../subject-model/subject-model.component';
@Component({
  selector: 'app-corporate-students',
  templateUrl: './corporate-students.component.html',
  styleUrls: ['./corporate-students.component.scss']
})
export class CorporateStudentsComponent implements OnInit {
  ...
  //   this.apiService.GetDetails("Corporate/bookings?corporateAccId="+corporateAccId+ "&subjectId="+3+"&pageNumber="+1+"&pageSize="+10).subscribe(rtnData => {
  //     debugger;
  //     console.log('rtnData', rtnData);
